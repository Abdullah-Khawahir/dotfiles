...
local function start_dashboard()
    vim.cmd('enew')
    vim.keymap.set('n', 'n', ':enew<CR>', { noremap = true, silent = true, buffer = vim.api.nvim_get_current_buf() })
    vim.keymap.set('n', ']]', start_dashboard, { noremap = true, silent = true, buffer = vim.api.nvim_get_current_buf() })
